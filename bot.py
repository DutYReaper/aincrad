...
async def coinflip(interaction: discord.Interaction, choice: str, amount: int):
    ...
    embed.set_image(url="https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExYXQwNWtzbW52bjJ6aW4yemhwMHAxYmZ6MzExZzd0MGgzZTNjMTNnbyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/1n7cDjGhaHsmT5AUI3/giphy.gif")
    await interaction.response.send_message(embed=embed)
    await asyncio.sleep(3.0)
